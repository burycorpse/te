...
Wait(2)
--
local Window = ui:NewWindow{window = {Name = [[<b>"Sentinel<font color="rgb(220, 20, 60)"> X</font></b>]], Description = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name}, User = {Name = LocalPlayer.Name,Role = 'Buyer Build'}}
...
-- 
ui:Notify{text = "Sentinel has loaded in ".. Round(tostring(tick() - utility.LastTick)).. " seconds !", time = 5, style = "loading"}
